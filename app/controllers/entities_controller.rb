class EntitiesController < ApplicationController
  ...
  private
    ...
    def entity_params
      params.require(:entity).permit(:titolo, :nativo, :rigenera_slug, :landing_page, :vetrina, :stato, :descrizione, :descrizione_lunga, :date, :plurale, :immagine, :tipo, :testo_pagamento, :ordine)
    end
end
